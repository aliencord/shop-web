...
export default function ForbiddenPage() {
  ...
  return (
    <section className="relative overflow-hidden px-6 sm:px-8 py-16 md:py-24 min-h-[85svh] md:min-h-[90svh] bg-black flex items-center justify-center">
      ...
      <div className="relative z-20 mx-auto max-w-4xl text-center">
        <h1 className="text-5xl font-extrabold tracking-tight text-primary">403</h1>
        <p className="mt-2 text-xl font-semibold">Forbidden</p>
